...
# Time-stamp: <2012-11-07 10:14:36 (jonah)>
...
TORQUE[0]="-l walltime=00:04:00:00"
TORQUE[1]="-l mem=2gb"
TORQUE[2]="-l vmem=2gb"
TORQUE[3]="-l procs=1"
TORQUE[4]="-j oe"
TORQUE[5]="-m a"
TORQUE[6]="-q janus-short"
TORQUE[7]="-V"
...
for i in $@; do # only works if the filenames have no spaces!
    ...
    printf '$(/home/jonah/utils/make_post_thermalization_script.sh %s $PBS_JOBID)\n\n' $(/home/jonah/utils/realpath $i) >> $i.sh
